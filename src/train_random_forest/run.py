...
def go(args):
    ...
    # Get the trainval data from the local file path provided by main.py
    logger.info(f"Reading trainval data from {args.trainval_file}")
    X = pd.read_csv(args.trainval_file)
